...
::__________________________________________________________
  ...
  echo.
  echo Digite:  1 - Para pesquisar
  echo          2 - Para ver todos
  echo          3 - Para adicionar
  echo          4 - Para atualizar
  echo          5 - Para BACKUP
