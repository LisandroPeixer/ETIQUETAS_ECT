...
::_________________________________________________________
 ...
 ::ANO+
  ...
  if %SIM%==1 (
      echo "<html><head><title></title><meta charset="utf-8"/><style>html, body {margin: 0px 0px 0px -12px; padding: 0px;} div {margin-left: 40px} table, th, td {margin: 15px; padding: 0px; font-size:20px; width:300px; border: 1px solid black; border-collapse: collapse; text-align:center;} #sequencia{font-size:50px;} div {page-break-after:always;} div:last-child {page-break-after:avoid;} </style></head><body>" > impressao.html

    for /f "tokens=5,1,2,3,4,5 delims=	" %%A in (lista.txt) do (
      echo "<div><table align=center><tr><th colspan=2>%%E</th></tr><tr><th colspan=2>%%D</th></tr><tr><th colspan=2 id=sequencia>%%C</th>  </tr>  <tr>    <td>ENTRADA</td>    <td>%%B</td>  </tr>  <tr>    <td>SAIDA</td>    <th>%SAIDADIA%/%SAIDAMES%/%SAIDAANO%</th>  </tr></table></div>" >> impressao.html 
